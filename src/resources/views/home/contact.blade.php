                            ...
                            <div class="row flex-row-reverse no-gutters">
                                        ...
                                        <form id="contactForm" name="contactForm" class="contactForm"
                                            ...
                                            <div class="form-floating mb-3">
                                                <input name="contactName" type="text" class="form-control shadow-sm"
                                                       id="contactNameid" placeholder="">
                                                <label for="contactNameid">Name</label>
                                            </div>
                                            <div class="form-floating" style="margin-bottom: 1.1em;">
                                                <input name="contactEmail" type="email" class="form-control shadow-sm"
                                                       id="contactEmailid" placeholder="">
                                                <label for="contactEmailid">Email</label>
                                            </div>
                                            <div class="form-floating mb-3">
                                                <textarea name="contactFeedback" class="form-control shadow-lg" rows="4"
                                ...
                                <div class="col-lg-4 col-md-5 d-flex align-items-stretch">
                                    <div class="info-wrap w-100 p-md-5 p-4" style="background-color: #00B074;">
                                        ...
                                        <p class="mb-4 m-0 text-white" style="font-size: 1.2em;">If you have any
                                            questions or to say something please feel free to contact us. <br> We
                                            appreciate your thoughts.</p>
                                        <div class="d-flex justify-content-center">
                                            <img src="{{url('images/email.png')}}" alt="email logo"
